  ...
  return (
    <section className=" relative information container ">
      <div className=' flex flex-col items-center ' >
          ...
          <div className="relative space-x-2 lg:space-x-[24px] lg:mb-[78px] ">
              ...
              <input
                ...
                className=" lg:w-[421px]  lg:h-[68px] pl-10 pr-4 py-3 border  border-gray-300 rounded-lg focus:outline-none bg-white "
              />
               <button className='bg-[#d84029] border-none rounded-[10px] mt-10 lg:mt-0 py-[12px] lg:py-[22px] px-[10px] lg:px-[50px]  text-[#FFFFFF] font-semibold text-[17px] font-open-sans ' >Subscribe</button>
            </div>
